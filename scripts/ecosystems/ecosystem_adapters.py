...
__all__ = [
    "EcosystemError", "CapabilityNotSupported", "UnknownEcosystem",
    "CapabilityType", "CommandSpec", "EcosystemCapability",
    "EcosystemAdapter", "EcosystemRegistry",
    "_build_go_adapter", "_build_npm_adapter", "_build_pip_adapter",
    "get_default_registry", "new_registry",
]
